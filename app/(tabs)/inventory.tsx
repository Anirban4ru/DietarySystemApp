...
import {
  ...
  ScrollView, Animated, PanResponder, ActivityIndicator, KeyboardAvoidingView, Platform
} from 'react-native';
...
import { TipFeed } from '@/components/ui/TipFeed';
          ...
          <View style={styles.itemContent}>
            ...
            <View style={[styles.actionRow, { justifyContent: 'flex-start', marginTop: 12 }]}>
              <PressScale onPress={onConsume} style={[styles.actionBtn, { borderColor: palette.sageDeep, backgroundColor: '#F0F7F4' }]}>
                <Check size={13} color={palette.sageDeep} strokeWidth={3} />
              ...
              <PressScale onPress={onTip} style={[styles.actionBtn, { borderColor: colors.border, backgroundColor: colors.bg, marginLeft: 'auto' }]}>
    ...
    <BottomSheet visible={visible} onClose={onClose}>
      <View style={styles.modalHeader}>
        ...
        <PressScale onPress={() => { Haptics.selectionAsync(); onClose(); }}>
          ...
          <Reanimated.View style={[shakeStyle, { marginBottom: spacing[3] }]}>
            <TextInput
              style={[styles.searchInput, { borderColor: colors.border, color: colors.text, backgroundColor: colors.surface, marginBottom: 0 }]}
