...
DROP POLICY IF EXISTS "user_select_inventory" ON inventory_items;
DROP POLICY IF EXISTS "user_insert_inventory" ON inventory_items;
DROP POLICY IF EXISTS "user_update_inventory" ON inventory_items;
DROP POLICY IF EXISTS "user_delete_inventory" ON inventory_items;
...
-- 2. user_profile
ALTER TABLE user_profile ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE user_profile ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_profile" ON user_profile;
DROP POLICY IF EXISTS "user_insert_profile" ON user_profile;
DROP POLICY IF EXISTS "user_update_profile" ON user_profile;
DROP POLICY IF EXISTS "user_delete_profile" ON user_profile;
...
-- 3. impact_log
ALTER TABLE impact_log ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE impact_log ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_impact" ON impact_log;
DROP POLICY IF EXISTS "user_insert_impact" ON impact_log;
DROP POLICY IF EXISTS "user_update_impact" ON impact_log;
DROP POLICY IF EXISTS "user_delete_impact" ON impact_log;
...
-- 4. disposal_events
ALTER TABLE disposal_events ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE disposal_events ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_disposal" ON disposal_events;
DROP POLICY IF EXISTS "user_insert_disposal" ON disposal_events;
DROP POLICY IF EXISTS "user_update_disposal" ON disposal_events;
DROP POLICY IF EXISTS "user_delete_disposal" ON disposal_events;
...
-- 5. recipe_favorites
ALTER TABLE recipe_favorites ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE recipe_favorites ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_recipe_favorites" ON recipe_favorites;
DROP POLICY IF EXISTS "user_insert_recipe_favorites" ON recipe_favorites;
DROP POLICY IF EXISTS "user_update_recipe_favorites" ON recipe_favorites;
DROP POLICY IF EXISTS "user_delete_recipe_favorites" ON recipe_favorites;
...
-- 6. shopping_list
ALTER TABLE shopping_list ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE shopping_list ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_shopping_list" ON shopping_list;
DROP POLICY IF EXISTS "user_insert_shopping_list" ON shopping_list;
DROP POLICY IF EXISTS "user_update_shopping_list" ON shopping_list;
DROP POLICY IF EXISTS "user_delete_shopping_list" ON shopping_list;
...
-- 7. meal_plan
ALTER TABLE meal_plan ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE meal_plan ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_meal_plan" ON meal_plan;
DROP POLICY IF EXISTS "user_insert_meal_plan" ON meal_plan;
DROP POLICY IF EXISTS "user_update_meal_plan" ON meal_plan;
DROP POLICY IF EXISTS "user_delete_meal_plan" ON meal_plan;
...
-- 8. weekly_goals
ALTER TABLE weekly_goals ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE weekly_goals ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_weekly_goals" ON weekly_goals;
DROP POLICY IF EXISTS "user_insert_weekly_goals" ON weekly_goals;
DROP POLICY IF EXISTS "user_update_weekly_goals" ON weekly_goals;
DROP POLICY IF EXISTS "user_delete_weekly_goals" ON weekly_goals;
...
-- 9. xp_state
ALTER TABLE xp_state ADD COLUMN IF NOT EXISTS user_id uuid;
ALTER TABLE xp_state ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_select_xp_state" ON xp_state;
DROP POLICY IF EXISTS "user_insert_xp_state" ON xp_state;
DROP POLICY IF EXISTS "user_update_xp_state" ON xp_state;
DROP POLICY IF EXISTS "user_delete_xp_state" ON xp_state;
